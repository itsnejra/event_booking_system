...
Aplikacija se pokreće sa napunjenim demo podacima, pa nema faze pripreme — sve što je niže opisano
može se vidjeti odmah. Ovaj dokument vodi kroz sedam scenarija, redom, i uz svaki korak stoji šta
tačno treba da se ispiše. Ako se ispiše nešto drugo, to je nalaz.
...
Scenariji se oslanjaju jedan na drugi i najbolje ih je proći redom. Gdje neki korak mijenja brojke
u kasnijem koraku, to je izričito naglašeno.
...
prodane su 2, i počinje za manje od 48 sati. Razlog otkazivanja koji stoji u obavijesti
...
kroz `IClock`, pa se ovakvo ponašanje može posmatrati umjesto da se uzima na riječ.
